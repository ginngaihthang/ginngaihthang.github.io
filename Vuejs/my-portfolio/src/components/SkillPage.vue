<template>
    <div id="skill">
        ...
        <div class="row min-vh-100" >
              <h1 class="d-flex flex-column justify-content-center my-4">Skills</h1> 
              <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nisi odio vitae repellendus aperiam cum commodi, repellat sapiente rerum quia quis excepturi adipisci, at eos vero. Neque iste aspernatur.</p>
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                <!-- <h5 class="fw-bold mb-3 text-start">Skills & Experiences</h5> -->
                <div class="lead text-start">
                    
                    <ul class="list-group mt-3">
                        <li class="list-group-item p-0 mb-3 shadow_css   border-0">
                            <div class="ps-3 py-2">
                                ...
                                <small>  HTML 5</small>
                                <small class="float-end p-2">90%</small>
                            </div>
                        ...
                        <li class="list-group-item p-0 mb-3 shadow_css  border-0 proces">
                            <div class="ps-3 py-2">
                                ...
                                <small>  CSS 3</small>
                                <small class="float-end p-2">80%</small>
                            </div>
                        ...
                        <li class="list-group-item p-0 mb-3 shadow_css border-0 proces">
                            <div class="ps-3 py-2">
                                ...
                                <small class="float-end p-2">70%</small>
                            </div>
                        ...
                        <li class="list-group-item p-0 mb-3 shadow_css border-0 proces">
                            <div class="ps-3 py-2">
                                ...
                                <small>  Figama</small>
                                <small class="float-end p-2">60%</small>
                            </div>
                            <div class="progress-bar bg-danger skillset" role="progressbar" style="width: 60%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                        </li>
                    </ul>
                </div>
            </div>
                
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 lead text-start">
                <ul class="list-group mt-3">
                        <li class="list-group-item p-0 mb-3 shadow_css   border-0">
                            <div class="ps-3 py-2">
                                <svg xmlns="http://www.w3.org/2000/svg"  width="30" height="30" fill="currentColor" class="bi bi-filetype-html text-danger" viewBox="0 0 384 512">
